    ...
    return (
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="flex flex-col items-center">
          ...
          <p className="text-slate-400">{t("loading_counselors")}</p>
        </div>
      </div>
    );
  }
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-2xl text-center">
          ...
          <div className="p-8 flex flex-col items-center justify-center text-center">
            ...
            <h3 className="text-lg font-medium text-white mb-1">{t("no_counselors_available")}</h3>
            <p className="text-slate-400 max-w-xs">
              {t("no_counselors_available_desc")}
            </p>
          </div>
        </div>
      </div>
        ...
        <ul className="flex flex-col divide-y divide-white/10 rounded-xl border border-white/10 bg-white/5 backdrop-blur supports-[backdrop-filter]:bg-white/5">
          {counselors.map((counselor) => (
            <li
              ...
              role="button"
              aria-label={`${t("open_chat_with")} ${counselor.name}`}
              tabIndex={0}
              onKeyDown={(e) => {
            ...
            {isInitialLoading && (
              <div className="absolute inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-slate-300 text-sm">{t("loading_ai_chat")}</p>
                </div>
              </div>
            )}
