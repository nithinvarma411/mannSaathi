      ...
      <main className="overflow-y-auto hide-scrollbar text-slate-100 relative" style={{height: '100vh'}}>
        ...
        <div className="relative z-10 mx-auto w-full max-w-6xl px-3 sm:px-4 pb-16 sm:pb-20">
          <div className="mb-6 sm:mb-8 pt-20 sm:pt-16">
            ...
            <p className="text-sm sm:text-base text-slate-300">{t("search_view_info")}</p>
          </div>
          ...
          {searchResults.length === 0 && debouncedSearch && (
            <div className="bg-white/5 border border-white/10 rounded-lg p-6 sm:p-8 text-center">
              ...
              <h3 className="text-base sm:text-lg font-medium text-slate-100 mb-2">{t("no_results_found")}</h3>
              <p className="text-sm sm:text-base text-slate-300">{t("try_adjusting_search")}</p>
            </div>
          )}
          ...
          {!debouncedSearch && (
            <div className="bg-white/5 border border-white/10 rounded-lg p-6 sm:p-8 text-center">
              ...
              <h3 className="text-base sm:text-lg font-medium text-slate-100 mb-2">{t("start_typing_to_search")}</h3>
              <p className="text-sm sm:text-base text-slate-300">{t("enter_name_email_to_find")}</p>
            </div>
          )}
        </div>
      </main>
