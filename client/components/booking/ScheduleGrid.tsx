        ...
        <div className="grid grid-cols-9 gap-0">
          ...
          {timeSlots.map((time) => (
            <div key={time} className="p-4 border-b border-r border-white/10 bg-white/5 text-center">
              <span className="text-sm font-medium text-slate-300">{t(time)}</span>
            </div>
          ))}
                    ...
                    {appointment ? (
                      ...
                      >
                        <div className="text-center">
                          <div className="font-medium">{t(appointment.time)}</div>
                ...
                return (
                  <div key={`${counselor.id}-${timeSlot}`} className="min-h-[60px]">
                    {appointment ? (
                      ...
                      >
                        <div className="text-center">
                          <div className="font-medium text-xs">{t(timeSlot)}</div>
